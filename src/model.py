...
class Critic(nn.Module):
    """Critic (Value) Model: centralized critic gets full state and full action."""

    def __init__(self, full_state_size, full_action_size, seed=0, fcs1_units=256, fc2_units=256):
        super().__init__()
        torch.manual_seed(seed)
